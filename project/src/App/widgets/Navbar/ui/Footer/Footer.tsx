    ...
    <div className={cls.footer}>
      <div className="container">
        <div className={cls.footer_wrap}>
          <div className={cls.block_footer_body}>
            <label className={cls.footer_label}>
              <h3 className={cls.text_footer}>
              ...
              <div className={cls.footer_block}>
                <p className={cls.text_block}>
                  Contact us below to work together to build your{' '}
                  <span style={{ display: 'block' }}>amazing interior</span>
                </p>
                <Link to="/contactus">
                  <Button
                    variant="primary_white"
                    size="medium"
                    className={cls.footer_block_btn}
                  >
                    Contact Us
                  </Button>
                </Link>
            ...
            <div className={cls.logo_desc}>
              ...
              <h3 className={cls.text_logo_footer}>
                One of the best furniture{' '}
                <span style={{ display: 'block' }}>agency.</span>
              </h3>
            </div>
            <div className={cls.text_1}>
              <div className={cls.circle}></div>
              <span className={cls.txt_email} style={{ marginTop: '-100px' }}>
              ...
              <img
                ...
                alt=""
              />
              <p style={{ color: '#D9D9D9', marginLeft: '-22px' }}>
                Email Address
              </p>
              <hr
                style={{
            ...
            <span className={cls.latest_txt} style={{ color: '#333333' }}>
              Follow us On
            </span>
