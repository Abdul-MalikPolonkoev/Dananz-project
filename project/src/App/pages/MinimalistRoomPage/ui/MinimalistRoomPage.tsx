        ...
        <div className={cls.minimalistroom_wrap}>
          ...
          <section>
            <div className={cls.minimalistroom_block}>
              ...
              <span className={cls.minimalistroom_desc}>
                It is a long established fact that a reader will be{' '}
                <span className={cls.textdd} style={{ display: 'block' }}>
                  distracted by the readable content of a page when
                </span>
                looking at its layout.
              </span>
              <img
                className={cls.minimalistroom_img}
                src={minimalistroom_photo}
                alt=""
              />
            </div>
            <div className={cls.minimalist_block_text}>
              <div className={cls.minimalist_block_item}>
                ...
                <span className={cls.minimalist_desc_item}>
                  ...
                  <span style={{ display: 'block', marginTop: '5px' }}>
                    learning can be done anytime and anywhere. Online learning
                  </span>
                  <span style={{ display: 'block', marginTop: '5px' }}>
                    with us does not interfere with your daily life. because
                    learning{' '}
                  </span>
                  <span style={{ display: 'block', marginTop: '5px' }}>
              ...
              <div
                className={cls.minimalist_block_item}
              ...
              >
                ...
                <div style={{ marginTop: '35px' }}>
                  <span
                    className={cls.minimalist_desc_item}
            ...
            <div className={cls.minimalist_block_images}>
              ...
              <img
                ...
                className={cls.image_1}
                src={minimalistroom_photo3}
                alt=""
              />
              <img
                style={{ marginTop: '28px' }}
                className={cls.image_2}
                src={minimalistroom_photo4}
                alt=""
              />
              <img
                style={{ marginTop: '28px' }}
                className={cls.image_1}
                src={minimalistroom_photo5}
                alt=""
              />
              <img
                style={{ marginLeft: '32px' }}
                className={cls.image_1}
                src={minimalistroom_photo6}
                alt=""
              />
            </div>
          </section>
