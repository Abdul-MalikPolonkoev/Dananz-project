      ...
      <div className="container">
        <div className={cls.services_wrap}>
          ...
          <div className={cls.services_block}>
            ...
            <span className={cls.services_desc}>
          ...
          <div className={cls.product_block_footer}>
            <div className={cls.product_block_logo}>
              ...
              <h3 className={cls.product_block_logo2}>
                Choose your{' '}
                <span style={{ display: 'block' }}>product themes.</span>
              </h3>
              <p className={cls.product_block_desc}>
                Find the theme you want. If our choice of theme is
                <span style={{ display: 'block', marginTop: '5px' }}>
                  not what you want, you can customize it as you
                </span>
                <span style={{ display: 'block', marginTop: '5px' }}>
                  want.
                </span>
            ...
            <div className={cls.product_block_main}>
              <div className={cls.block_main_item}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <Link to="/portofolio">
                    <img
                      style={{ marginLeft: '919px' }}
                      className={cls.block_arrow}
                      src={arrow_right}
                      alt=""
                    />
                  </Link>
                </div>
                <p className={cls.desc_1}>
              ...
              <div
                style={{ marginTop: '-6px' }}
                className={cls.block_main_item}
              >
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <h2 className={cls.logo_1}>02</h2>
                  <span style={{ marginLeft: '82px' }} className={cls.logo_2}>
                    Minimalist
                  </span>
                  <Link to="/portofolio">
                    <img
                      style={{ marginLeft: '879px' }}
                      className={cls.block_arrow}
                      src={arrow_right}
                      alt=""
                    />
