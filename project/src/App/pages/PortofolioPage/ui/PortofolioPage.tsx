...
export const PortofolioPage = memo(() => {
  return (
      ...
      <div className="container">
        <div className={cls.portofolio_wrap}>
          ...
          <div className={cls.portofolio_block}>
            ...
            <span className={cls.portofolio_desc}>
          ...
          <div className={cls.block_portofolio_footer}>
            ...
            <img
              className={cls.portofolio_img_footer}
              src={portofolio_photo}
              alt=""
            />
            ...
            <div className={cls.block_minimalist_room}>
              ...
              <Button
                className={cls.minimalist_room_btn}
                variant="default"
                size="small"
              >
                See More
          ...
          <div className={cls.vintage_room_block}>
            ...
            <div className={cls.vintage_block}>
              ...
              <Button
                variant="default"
                size="small"
                className={cls.vintage_block_btn}
              >
                See More
              </Button>
          ...
          <div className={cls.modern_room_block}>
            ...
            <div className={cls.modern_block}>
              ...
              <Button
                variant="default"
                size="small"
                className={cls.modern_block_btn}
              >
                See More
              </Button>
          ...
          <div className={cls.transitional_room_block}>
            <img
              className={cls.transitional_img}
              src={portofolio_photo4}
              alt=""
            />
            <div className={cls.transitional_block}>
              ...
              <Button
                variant="default"
                size="small"
                className={cls.transitional_block_btn}
              >
                See More
              </Button>
          ...
          <div className={cls.latest_about_block}>
            ...
            <p className={cls.latest_about_desc}>
          ...
          <div className={cls.about_cards}>
            {customizeCards.map((item, index) => (
              <div key={index} className={cls.card_item}>
                ...
                <span className={cls.text_desc} style={{ display: 'block' }}>
                  Customize your interior design into a
                  <span style={{ display: 'block' }}>
                    dream place with the best designers{' '}
                  </span>
                  <span style={{ display: 'block' }}>
